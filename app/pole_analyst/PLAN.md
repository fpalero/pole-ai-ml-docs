...
| 26 | FE media auth (`?token=` en todos los bindings `<img>`/`<video>` + retry-once-with-fresh-token) + tool-chip artifact links (077) | 📋 PLANNED (076, 077 📋 PLANNED) | [plan/PLAN_PHASE_26.md](plan/PLAN_PHASE_26.md) |
