...
<!-- Cross-repo note: primary delivery is pole_api code; the small helm env-wiring step (step 3)
     targets helm/pole-ai/charts/pole-api (infra repo) and is coordinated within the phase. -->
## Repository
pole-ai-ml
