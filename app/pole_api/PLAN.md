...
| 29 | Staging QA follow-ups (image endpoint + path-leak strip + `segment_insight` trim + failed-turn signal + turn deadline [095 adopted] + answer shaping [096] + blank hardening [097]) | 📋 PLANNED | [PLAN_PHASE_29.md](plan/PLAN_PHASE_29.md) |
