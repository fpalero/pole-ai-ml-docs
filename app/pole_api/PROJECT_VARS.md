...
> 103 = `phase-29-staging-qa-followups/PAIML-POLE-API-103.md` (reserved, parallel
> branch `feature/PAIML-POLE-API-103-inflight-tool-grace` — in-flight tool grace).
> 104 = `phase-33-test-collection-hygiene/PAIML-POLE-API-104.md` (reserved, parallel
> branch `feature/PAIML-POLE-GATE-HYGIENE-API104-FE14` — duplicate pytest basename).
> 105 = `phase-29-staging-qa-followups/PAIML-POLE-API-105.md` (staging-gate harness:
> E2E_FAKES unset for coach-flow integration test).
> 106 = `phase-34-unified-images/PAIML-POLE-API-106.md` (parallel branch
> `feature/PAIML-POLE-API-106-unified-images-docs`, commit 12d096f — NOT an
> ancestor of `feature/PAIML-POLE-COACH-docs`; counter on this branch was 105,
